...
///
////////////////////////////////////////////////////////////
float getElevation(const sf::Vector2u& position)
{
    const sf::Vector2f normalized = sf::Vector2f(position).cwiseDiv(sf::Vector2f(resolution)) - sf::Vector2f(0.5f, 0.5f);
...
///
////////////////////////////////////////////////////////////
float getMoisture(const sf::Vector2u& position)
{
    const sf::Vector2f normalized = sf::Vector2f(position).cwiseDiv(sf::Vector2f(resolution)) - sf::Vector2f(0.5f, 0.5f);
...
///
////////////////////////////////////////////////////////////
const auto scalingFactors = sf::Vector2f(windowSize).cwiseDiv(sf::Vector2f(resolution));

sf::Vertex computeVertex(const sf::Vector2u& position)
{
    sf::Vertex vertex;
    vertex.position  = sf::Vector2f(position).cwiseMul(scalingFactors);
